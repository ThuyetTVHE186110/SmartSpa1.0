...
<html lang="en">
    ...
    <body>
        ...
        <form class="form form-container"action="ResetPasswordServlet" method="POST">
            ...
            <div class="input_container">
                <label class="input_label" for="email_field">New Password</label>
                ...
                <input placeholder="New Password" title="Inpit title" name="newPassword" type="text" class="input_field"
            ...
            <div class="input_container">
                ...
                <input placeholder="Confirm new Password" title="Inpit title" name="confirm" type="password" class="input_field"
