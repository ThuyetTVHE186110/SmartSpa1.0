    ...
    <body>
        ...
        <form class="form form-container" action="ResetPasswordServlet" method="POST" onsubmit="return validateForm()">
            ...
            <div class="title_container">
                ...
                <span class="subtitle">Enter your new password and confirm the new password.</span>
            </div>
            <br>
            ...
            <div class="input_container">
                ...
                <input placeholder="Password" title="Input your password" name="txtPassword" type="password" 
                       class="input_field" id="password_field" minlength="8" maxlength="20" required 
            ...
            <span id="password_error" class="error-message" style="color: red; display: none;"></span>



            <!-- Confirm Password Field -->
            <div class="input_container">
                <label class="input_label" for="confirm_password_field">Confirm New Password</label>
                <!-- SVG Icon -->
                <svg fill="none" viewBox="0 0 24 24" height="24" width="24" xmlns="http://www.w3.org/2000/svg" class="icon">
                <path stroke-linecap="round" stroke-width="1.5" stroke="#141B34"
                      d="M18 11.0041C17.4166 9.91704 16.273 9.15775 14.9519 9.0993C13.477 9.03404 11.9788 9 10.329 9C8.67911 9 7.18091 9.03404 5.70604 9.0993C3.95328 9.17685 2.51295 10.4881 2.27882 12.1618C2.12602 13.2541 2 14.3734 2 15.5134C2 16.6534 2.12602 17.7727 2.27882 18.865C2.51295 20.5387 3.95328 21.8499 5.70604 21.9275C6.42013 21.9591 7.26041 21.9834 8 22">
                ...
                <input placeholder="Confirm Password" title="Confirm your password" name="txtConfirmPassword" 
                       type="password" class="input_field" id="confirm_password_field" minlength="8" maxlength="20" 
            ...
            <span id="confirm_password_error" class="error-message" style="color: red; display: none;"></span>
            <!-- JavaScript Validation -->
            <script>
                // Function to toggle password visibility
                function togglePassword(fieldId) {
                    const passwordField = document.getElementById(fieldId);
                    const button = event.currentTarget; // Get the current button being clicked
                ...
                function validatePassword() {
                    ...
                    // Regex for password criteria: uppercase, number, special char, and length 8-20
                    const passwordCriteria = /^(?=.*[A-Z])(?=.*\d)(?=.*[@$!%*?&])[A-Za-z\d@$!%*?&]{8,20}$/;
                    let isValid = true;
                    ...
                    if (!password.match(passwordCriteria)) {
                        passwordError.innerText = "Password must contain 8-20 characters, including uppercase letter, number, and special character.";
