...
<html lang="en">
    ...
    <body>
        ...
        <form class="form form-container"action="VerifyRegistrationOtpServlet" method="POST">
            <div class="logo_container"></div>
            <div class="title_container">
                <p class="title">Confirm your Email information</p>
                <span class="subtitle">Enter the OTP sent to your email.</span>
            </div>
            <br>
            <!-- Username Field -->
            <div class="input_container">
                <label class="input_label" for="otp_field">Enter the OTP</label>
                ...
                <input placeholder="6 Digits Number" title="Input title" name="otp" type="text" class="input_field"
                       id="otp_field" maxlength="6" required onkeypress="return event.charCode >= 48 && event.charCode <= 57;">
            </div>
    ...
    <script>
        function validateOtp() {
            ...
            if (!/^\d{6}$/.test(otpInput)) {
                errorContainer.textContent = "Please enter a valid 6-digit OTP.";
                errorContainer.style.color = 'red'; // Set error message color
