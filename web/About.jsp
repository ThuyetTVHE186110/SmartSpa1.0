        ...
        <section class="about-main">
            <div class="about-container">
                <div class="about-intro" data-aos="fade-up">
                    <h2>Welcome to Blushed Beauty Bar</h2>
                    <p>Founded in 2018, Blushed Beauty Bar has grown from a small lash studio into Fargo's premier beauty
                        destination. Our passion for beauty and commitment to excellence drives everything we do.</p>
                </div>

                <div class="about-grid">
                    <div class="about-image" data-aos="fade-right">
                        <img src="newUI/assets/img/about_mission.png" alt="Blushed Beauty Bar Interior">
                    </div>
                    <div class="about-text" data-aos="fade-left">
                        <h3>Our Mission</h3>
                        <p>At Blushed Beauty Bar, we believe that everyone deserves to feel beautiful and confident. Our
                            mission is to provide exceptional beauty services in a welcoming, relaxing environment where
            ...
            <div class="team-container">
                ...
                <div class="team-grid">
                    <div class="team-member" data-aos="fade-up">
                        ...
                        <p class="bio">With over 8 years of experience, Sarah leads our team with passion and expertise.</p>
                    </div>
                    <div class="team-member" data-aos="fade-up" data-aos-delay="100">
                        <img src="./assets/img/team-member-2.jpg" alt="Team Member">
                        <h3>Emily Davis</h3>
                        <p class="position">Senior Esthetician</p>
                        <p class="bio">Emily specializes in creating customized skincare experiences for our clients.</p>
                    </div>
                    <div class="team-member" data-aos="fade-up" data-aos-delay="200">
                        <img src="./assets/img/team-member-3.jpg" alt="Team Member">
                        <h3>Lauren Smith</h3>
                        <p class="position">Microblading Artist</p>
                        <p class="bio">Lauren's attention to detail creates perfect, natural-looking brows.</p>
                    </div>
                    <div class="team-member" data-aos="fade-up" data-aos-delay="300">
                        <img src="./assets/img/team-member-4.jpg" alt="Team Member">
                        <h3>Jessica Chen</h3>
                        <p class="position">Advanced Lash Artist</p>
                        <p class="bio">Jessica's artistic eye creates stunning, customized lash looks for every client.</p>
                    </div>
                    <div class="team-member" data-aos="fade-up" data-aos-delay="400">
                        ...
                        <p class="bio">Rachel's expertise in advanced skincare treatments helps clients achieve their best
                            skin.</p>
                    </div>
                </div>
            </div>
        ...
        <section class="location-section">
            <div class="location-container">
                <div class="location-info" data-aos="fade-right">
                    ...
                    <button class="book-now-btn">Book an Appointment</button>
                </div>
