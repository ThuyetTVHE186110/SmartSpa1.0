    ...
    <body>
        ...
        <form class="form form-container" action="signup" method="POST">
            ...
            <div class="input_container">
                ...
                <input placeholder="name@mail.com" title="Input title" name="txtEmail" type="email" class="input_field"
            ...
            <div class="input_container">
                ...
                <input placeholder="Password" title="Input title" name="txtPassword" type="password" class="input_field"
            ...
            <div class="input_container">
                ...
                <input placeholder="Confirm Password" title="Input title" name="txtConfirmPassword" type="password"
                       class="input_field" id="confirm_password_field" required>
            </div>
