...
<%
    // Check if session or account attribute is null
    if (session == null || session.getAttribute("account") == null) {
        ...
        if (account.getRole() == 4) {
            // Redirect to booking page if user role is 4
            response.sendRedirect("booking");
        } else {
            // Set an error message and forward to an error page if access is denied
