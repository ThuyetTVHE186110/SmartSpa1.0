...
<html lang="en">
    ...
    <head>
        ...
        <title>Employee Management - NiceAdmin</title>
        ...
        <aside id="sidebar" class="sidebar">
            ...
            <ul class="sidebar-nav" id="sidebar-nav">
                ...
                <li class="nav-item">
                    ...
                    <ul id="manager-nav" class="nav-content collapse show" data-bs-parent="#sidebar-nav">
                        <li>
                        ...
                        <li>
                            <a href="productmanagement.html" class="active">
                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <p>Manage employees from this panel.</p>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <form class="row g-3">
                            ...
                            <div class="col-12">
                                <label for="inputImage" class="form-label">Employee Image</label>
        ...
        <div class="modal fade" id="editEmployeeModal" tabindex="-1">
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <!-- Edit Employee Form -->
                        <form class="row g-3" action="employee-management" method="post">
                            <input type="hidden" name="id" id="inputEmployeeId"> <!-- Hidden field for Employee ID -->
                            <div class="col-12">
                                <label for="inputEmployeeName" class="form-label">Employee Name</label>
            ...
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <form class="row g-3">
                            <div class="col-12">
                                <label for="viewEmployeeName" class="form-label">Employee Name</label>
                                <input type="text" class="form-control" id="viewEmployeeName" readonly>
                            </div>
                            <div class="col-12">
                                <label for="viewEmployeeDOB" class="form-label">Date of Birth</label>
                                <input type="text" class="form-control" id="viewEmployeeDOB" readonly>
                            </div>
                            <div class="col-12">
                                <label for="viewEmployeeGender" class="form-label">Gender</label>
                                <input type="text" class="form-control" id="viewEmployeeGender" readonly>
                            </div>
                            <div class="col-12">
                                <label for="viewEmployeeEmail" class="form-label">Email</label>
                                <input type="text" class="form-control" id="viewEmployeeEmail" readonly>
                            </div>
                            <div class="col-12">
                                <label for="viewEmployeePhone" class="form-label">Phone</label>
                                <input type="text" class="form-control" id="viewEmployeePhone" readonly>
                            </div>
                            <div class="col-12">
                                <label for="viewEmployeeAddress" class="form-label">Address</label>
                                <input type="text" class="form-control" id="viewEmployeeAddress" readonly>
                            </div>
                        </form>
                        <!-- End View Employee Form -->
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
                    </div>
    ...
    <script>
                                                        function confirmDelete(id) {
                                                            if (confirm("Are you sure you want to delete this employee?")) {
                                                                ...
                                                                $.post('employee-management', {action: 'delete', id: id}, function () {
                                                        ...
                                                        function confirmDelete(id) {
                                                            ...
                                                            if (isConfirmed) {
                                                                // If user confirm delete employee => delete employee
                                                                // Send requirment delete to Servet
                                                                fetch(`employee-management/delete?id=${e.id}`, {
                                                                    method: 'DELETE'
                                                                })
                                                                        .then(response => {
                                                                            if (response.ok) {
                                                        ...
                                                        document.addEventListener('DOMContentLoaded', function () {
                                                            const editButtons = document.querySelectorAll('button[data-bs-target="#editEmployeeModal"]');
                                                            ...
                                                            editButtons.forEach(button => {
                                                                button.addEventListener('click', function () {
                                                                    ...
                                                                    document.getElementById('inputEmployeeId').value = id;
                                                        ...
                                                        function setModalData(name, dob, gender, email, phone, address) {
                                                            document.getElementById('viewEmployeeName').value = name;
                                                            document.getElementById('viewEmployeeDOB').value = dob;
                                                            document.getElementById('viewEmployeeGender').value = gender;
                                                            document.getElementById('viewEmployeeEmail').value = email;
                                                            document.getElementById('viewEmployeePhone').value = phone;
                                                            document.getElementById('viewEmployeeAddress').value = address;
                                                        }
