                                ...
                                ? " newUI/assets/img/" + person.getImage() : "newUI/assets/img/default-avartar.jpg" %>"
                                            ...
                                            <div class="profile-content">
                                                ...
                                                <div class="profile-tab" id="preferences">
                                                    ...
                                                    <form class="preferences-form" action="customerProfile"
                                                    ...
                                                    <form class="settings-form" action="customerProfile" method="post"
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <select name="gender" required>
                                                                <option value="M" <%=(person.getGender()=='M' )
                                                                    ? "selected" : "" %>
                                                                    >Male</option>
                                                                <option value="F" <%=(person.getGender()=='F' )
                                                                    ? "selected" : "" %>
                                                                    >Female</option>
                                                                <option value="O" <%=(person.getGender()=='O' )
                                                                    ? "selected" : "" %>
                                                                    >Other</option>
                                                            </select>
                                                        </div>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <input type="tel" name="phone"
                                                                value="<%= person.getPhone()%>" required>
                                                        </div>
                                                        <!-- Address -->
                                                        <div class="form-group">
                                                            <label>Address</label>
                                                            <input type="text" name="address"
                                                                value="<%= person.getAddress()%>" required>
                                                        </div>
                                                        <!-- Email -->
                                                        <div class="form-group">
                                                            <label>Email</label>
                                    ...
                                    <% String successMessage=(String) session.getAttribute("successMessage"); String
                                        errorMessage=(String) request.getAttribute("errorMessage"); if (successMessage
                                        !=null) { %>
