        ...
        <%@page contentType="text/html" pageEncoding="UTF-8" %>
            <%@ page import="model.Account" %>
                <%@ page import="model.Person" %> <!-- Import Person class -->
                    <% // Kiểm tra xem người dùng đã đăng nhập hay chưa Account
                        account=(Account)session.getAttribute("account"); if(account==null) { // Nếu chưa đăng nhập,
                        chuyển hướng tới trang lỗi hoặc login response.sendRedirect("error"); return; } // Lấy thông tin
                        cá nhân từ đối tượng account Person person=account.getPersonInfo(); // Kiểm tra quyền hạn (chỉ
                        cho phép customer role) if(account.getRole() !=4) { response.sendRedirect("error"); return; } %>
                        ...
                        <body>
                            ...
                            <section class="profile-section">
                                <div class="profile-container">
                                    ...
                                    ? " newUI/assets/img/" + person.getImage() : "newUI/assets/img/default-avartar.jpg"
                                                    %>"
                                                alt="Profile Picture">
                                            ...
                                            <div class="profile-details">
                                                <h1>
                                                    <c:out value="${account.personInfo.name}" />
                                                </h1> <!-- Display customer name -->
                                    ...
                                    <div class="profile-nav">
                                        <button class="profile-nav-btn active"
                                            data-tab="appointments">Appointments</button>
                                        <button class="profile-nav-btn" data-tab="history">History</button>
                                        <button class="profile-nav-btn" data-tab="settings">Account
                                            Information</button>
                                        <button class="profile-nav-btn" data-tab="preferences">Change
                                            Password</button>
                                    </div>
                                    ...
                                    <div class="profile-content">
                                        ...
                                        <div class="profile-tab active" id="appointments">
                                            ...
                                            <c:forEach items="${requestScope.history}" var="comming">
                                                    ...
                                                    <div class="appointments-grid">
                                                        <div class="appointment-card">
                                                            ...
                                                            <div class="appointment-details">
                                                                <h3>${comming.services.service.name}</h3>
                                                                <p><i class="far fa-clock"></i> 2:00 PM - 4:30 PM
                                                                </p>
                                                                <p><i class="far fa-clock"></i>
                                                                    ${comming.start.toLocalTime()} - 4:30 PM</p>
                                                                <p><i class="fas fa-user"></i> with Jessica Chen</p>
                                                            </div>
                                                            <div class="appointment-actions">
                                                                <button type="submit"
                                                                    class="reschedule-btn">Reschedule</button>
                                    ...
                                    <div class="profile-tab" id="preferences">
                                        ...
                                        <form class="preferences-form" action="customerProfile" method="post"
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div style="display: flex; align-items: center;">
                                                    <input type="password" id="password_field" name="password"
                                                        class="form-control" required oninput="validatePassword()">
                                                    <button type="button" class="show_password"
                                                        onclick="togglePassword('password_field')"
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div style="display: flex; align-items: center;">
                                                    <input type="password" name="confirmNewPassword"
                                                        id="confirmNewPassword" required minlength="8" maxlength="20"
                                            ...
                                            <button type="submit" class="save-preferences-btn">Save
                                                Changes</button>
                                        </form>
                                    </div>
                                    ...
                                    <div class="profile-tab" id="settings">
                                        ...
                                        <form class="settings-form" action="customerProfile" method="post"
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="fullName" value="<%= person.getName()%>"
                                                    required>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="date" name="dateOfBirth"
                                                    value="<%= person.getDateOfBirth() != null ? person.getDateOfBirth().toString() : ""%>"
                                                    required>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select name="gender" required>
                                                    <option value="M" <%=(person.getGender()=='M' ) ? "selected" : "" %>
                                                        >Male</option>
                                                    <option value="F" <%=(person.getGender()=='F' ) ? "selected" : "" %>
                                                        >Female</option>
                                                    <option value="O" <%=(person.getGender()=='O' ) ? "selected" : "" %>
                                                        >Other</option>
                                                </select>
                                            </div>
                                            ...
                                            <!-- Hiển thị lỗi email -->
                                            <!-- Submit Button -->
                                            <button type="submit" class="save-settings-btn">Save
                                                Changes</button>
                                        </form>
                                    </div>
                                </div>
                            ...
                            <% String successMessage=(String) session.getAttribute("successMessage"); String
                                errorMessage=(String) request.getAttribute("errorMessage"); if (successMessage !=null) {
                                %>
