    ...
    <body>
        ...
        <form class="form form-container"action="login" method="POST">
            ...
            <div class="title_container">
                ...
                <span class="subtitle">Login to Staff Account.</span>
            </div>
            <br>
            <!-- Username Field -->
            <div class="input_container">
                ...
                <input placeholder="name@mail.com" title="Inpit title" name="txtUsername" type="text" class="input_field"
            ...
            <div class="input_container">
                ...
                <input placeholder="Password" title="Inpit title" name="txtPassword" type="password" class="input_field"
        ...
        <script>
            document.addEventListener("DOMContentLoaded", function () {
                // Ki?m tra xem có d? li?u trong localStorage không
                if (localStorage.getItem("rememberMe") === "true") {
                    ...
                    document.getElementById("rememberMe").checked = true; // ?ánh d?u checkbox
                }

                // Khi form ???c g?i ?i
                document.getElementById("loginForm").addEventListener("submit", function (event) {
                    if (document.getElementById("rememberMe").checked) {
                        // L?u thông tin vào localStorage
                        ...
                        // Xóa thông tin n?u checkbox không ???c ch?n
