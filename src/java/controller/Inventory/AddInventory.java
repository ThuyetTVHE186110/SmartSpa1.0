 ...
 * @author hotdo
 */
@WebServlet(name="AddInventory", urlPatterns={"/addinventory"})
public class AddInventory extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        int monthlyUsageEstimate = Integer.parseInt(request.getParameter("monthlyUsageEstimate"));
        
        Inventory inventory = new Inventory();
        InventoryDAO inventoryDAO = new InventoryDAO();
        
        boolean result = inventoryDAO.addInventory(inventory);
        if (result) {
